...
public class LayoutManager extends JFrame{
   ...
   public void boderlayout()
   {
       ...
       JPanel pane = new JPanel(); // tao mot pane chinh chua cac thanh phan (pane) khac
       pane.setLayout(new BorderLayout()); // thiet lap kieu bo tri cac thanh phan ben trong no la borderlayout
               
       JPanel trai = new JPanel(); // tao mot cai pane con
       trai.setLayout(new FlowLayout()); // thiet lap de bo tri cac thanh phan ben trong no la flow layout
       trai.setBackground(Color.yellow);
       pane.add(trai, BorderLayout.WEST);
       trai.setPreferredSize(new Dimension(200, 0)); // ssetup kich thuoc cho trai , ta chi thiet lap chieu rong nen chieu dai de bang 0
     
       JButton button= new JButton("button");
       button.setForeground(Color.BLUE); //setup mau chu cho button 
